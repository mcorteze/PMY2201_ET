...
// Pantalla principal para gestionar el listado de mascotas
@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun MascotasScreen(viewModel: MainViewModel, navController: NavController) {
    // Escuchamos cambios en la lista de mascotas
    ...
    Scaffold(
        ...
        // Lista con desplazamiento vertical
        LazyColumn(
            modifier = Modifier
                .fillMaxSize()
            ...
            // Generamos una tarjeta por cada mascota
            items(mascotas) { mascota ->
                PetCard(
                    mascota = mascota,
                    onEdit = {
                        // Navegamos al formulario en modo edicion
...
// Tarjeta visual para mostrar datos de una mascota
@Composable
