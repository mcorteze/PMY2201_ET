...
// Pantalla inicial con estadisticas generales
@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun HomeScreen(onNavigate: (String) -> Unit) {
    // Obtenemos contexto y viewmodel asociado
    ...
    Scaffold(
        floatingActionButton = {
            // Boton para recargar los contadores
        ...
        if (uiState.isLoading) {
            ...
            // Cuadricula para las tarjetas de resumen
            LazyVerticalGrid(
                ...
                // Titulo de la seccion ocupando todo el ancho
                ...
                // Tarjeta de acceso a consultas medicas
                item(span = { GridItemSpan(2) }) {
                    DashboardCard(
                        title = "Consultas",
